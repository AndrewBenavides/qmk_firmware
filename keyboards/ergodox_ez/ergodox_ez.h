...
#define KEYMAP2( \
  ...
  L40, L41, L42, L43, L44,                        R42, R43, R44, R45, R46, \
                           L55, L56,    R50, R51, \
                                L66,    R60, \
                      L74, L75, L76,    R70, R71, R72 \
) { \
  { L00, L10, L20  , L30, L40  , KC_NO }, \
  { L01, L11, L21  , L31, L41  , L76   }, \
  { L02, L12, L22  , L32, L42  , L75   }, \
  { L03, L13, L23  , L33, L43  , L74   }, \
  { L04, L14, L24  , L34, L44  , L66   }, \
  { L05, L15, L25  , L35, KC_NO, L55   }, \
  { L06, L16, KC_NO, L36, KC_NO, L56   }, \
                                          \
  { R00, R10, KC_NO, R30, KC_NO, R50   }, \
  { R01, R11, R21  , R31, KC_NO, R51   }, \
  { R02, R12, R22  , R32, R42  , R60   }, \
  { R03, R13, R23  , R33, R43  , R72   }, \
  { R04, R14, R24  , R34, R44  , R71   }, \
  { R05, R15, R25  , R35, R45  , R70   }, \
  { R06, R16, R26  , R36, R46  , KC_NO }  \
}
...
#define KC_KEYMAP2( \
  ...
  KC_##L40, KC_##L41, KC_##L42, KC_##L43, KC_##L44,                                           KC_##R42, KC_##R43, KC_##R44, KC_##R45, KC_##R46, \
                                                    KC_##L55, KC_##L56,   KC_##R50, KC_##R51, \
                                                              KC_##L66,   KC_##R60, \
                                          KC_##L74, KC_##L75, KC_##L76,   KC_##R70, KC_##R71, KC_##R72 \
)
